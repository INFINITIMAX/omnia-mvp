...
- [x] Testele FastAPI și unit sunt complet mockuite; validarea locală: `python -m pytest -q` → 95 passed (1 warning extern de deprecere TestClient), `git diff --check` fără erori.
