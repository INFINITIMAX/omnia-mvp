...
- Căutarea semantică rulează numai fără intenție explicită și folosește top-K, prag și limită de context. Dacă întrebarea numește un document fără articol exact sau contextul rezolvă coduri la documente aprobate, căutarea semantică este restrânsă numai la acele documente; sub prag rezultatul este `not_found`, fără fallback global. Fără document explicit ori cod de context rezolvabil, căutarea globală rămâne neschimbată.
