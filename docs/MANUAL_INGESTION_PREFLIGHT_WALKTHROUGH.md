...
8. `_creeaza_chunkuri_locale()` și `_valideaza_chunkuri_locale()` verifică local că textul se poate separa în fragmente utile. Fragmentele rămân numai în memorie.
