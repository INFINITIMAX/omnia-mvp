...
- Catalogul curent Supabase/PostgreSQL conține 10 documente cu status `approved`. Numărul curent de chunk-uri indexate nu este consemnat aici fără o verificare read-only actualizată.
...
- Aplicația publică este live la merge commitul `47a6133` din `main`, publicat manual pe Railway la 08-09-2026. Healthcheck-ul `/health` și smoke-ul HTTPS fără provider au trecut; serviciul nu are Git Source/autodeploy legat.
