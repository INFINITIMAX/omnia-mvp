...
7. Verificarea numerică de după alias reutilizează separatorii oficiali (whitespace, slash, cratimă). Ea împiedică un alias scurt să accepte greșit un an sau o parte necunoscută, de exemplu `NP 010-2099` sau `NP 010 2099`.
8. `_has_known_article_suffix()` face excepția îngustă necesară: numai un articol nemarcat recunoscut imediat după codul complet, în același document, păstrează ruta exactă. Un articol apărut după anul necunoscut nu poate ocoli refuzul D13.
...
- După P1 numeric: 81 passed focalizat și 932 passed/11 skipped complet.
- După P1 exact-article: 105 passed focalizat și 962 passed/11 skipped complet; un warning extern Starlette/httpx.
